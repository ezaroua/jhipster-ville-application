...
import static fr.esgi.ville.domain.JoueurAsserts.*;
import static fr.esgi.ville.web.rest.TestUtil.createUpdateProxyForBean;
...
import fr.esgi.ville.repository.JoueurRepository;
...
class JoueurResourceIT {
    ...
    void partialUpdateJoueurWithPatch() throws Exception {
        ...
        partialUpdatedJoueur.dateInscription(UPDATED_DATE_INSCRIPTION);
